...
public class VerticalRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<ArrayList<PolarInfo>> mList;
    private ArrayList<PolarInfo> mmList;
    private SparseIntArray listPosition = new SparseIntArray();
    private HorizontalRecyclerAdapter.OnItemClickListener mItemClickListener;
    private Context mContext;

    public VerticalRecyclerAdapter(ArrayList<ArrayList<PolarInfo>> list) {
        this.mList = list;
    }
    ...
    private class CellViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ArrayList<PolarInfo> list) {
